...
*/
var parser = (function(){
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,4],$V1=[1,5],$V2=[1,6],$V3=[5,7,8,9];
var parser = {trace: function trace() {
        Jison.print.apply(null, arguments);
    },
yy: {},
symbols_: {"error":2,"compilationUnit":3,"es":4,"EOF":5,"e":6,"IF":7,"INTEGER_LITERAL":8,"IDENTIFIER":9,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",7:"IF",8:"INTEGER_LITERAL",9:"IDENTIFIER"},
productions_: [0,[3,2],[4,1],[4,2],[6,1],[6,1],[6,1],[6,0]],
...
table: [{3:1,4:2,5:[2,7],6:3,7:$V0,8:$V1,9:$V2},{1:[3]},{5:[1,7],6:8,7:$V0,8:$V1,9:$V2},o($V3,[2,2]),o($V3,[2,4]),o($V3,[2,5]),o($V3,[2,6]),{1:[2,1]},o($V3,[2,3])],
